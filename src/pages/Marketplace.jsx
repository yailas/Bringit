      ...
      <div className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            ...
            <button className="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bringit-500">
        ...
        {filteredRequests.length > 0 ? (
          ...
          <div className="text-center py-20">
            <p className="text-gray-500 text-lg">{t('marketplace.noRequests')}</p>
          </div>
        )}
      </div>
